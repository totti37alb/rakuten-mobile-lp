...
const benefits = [
  {
    ...
    label: "料金",
    title: "月額最安 1,078円〜",
    description: "3GBまで1,078円、無制限でも3,278円（いずれも税込）。データ使用量に応じて料金が決まるワンプラン。",
  },
  {
    num: "02",
    label: "データ",
    title: "データ無制限",
    description: "月3,278円（税込）でギガ上限なし。動画もSNSもストレスフリーで使い放題。",
  },
  {
    num: "03",
    label: "ポイント",
    title: "楽天ポイント還元",
    description: "楽天モバイル契約者は楽天市場でのポイント倍率がアップ（SPU）。詳細は楽天市場の公式ページで確認できます。",
  },
  {
    num: "04",
    label: "通話",
    title: "国内通話かけ放題",
    description: "Rakuten Linkアプリ使用時、国内通話が無料。毎月の電話代を丸ごと節約できる。",
  },
  {
    num: "05",
    label: "外でも",
    title: "動画・ライブ視聴にも",
    description: "外出先での動画視聴やリアルタイム投稿も、ギガを気にせず楽しめる。",
  },
  {
    num: "06",
    label: "縛りなし",
    title: "いつでもやめられる",
    description: "違約金・契約期間の縛り一切なし。「まずは試す」が気軽にできる。",
  },
];
